    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('administrador', 'Administrador'), ('alumno', 'Alumno'), ('invitado', 'Invitado'), ('docente', 'Docente'), ('preceptor', 'Preceptor')], max_length=20, verbose_name='Rol')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='Correo Electrónico')),
                ('telefono', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message='Formato de teléfono inválido', regex='^\\+?1?\\d{9,15}$')], verbose_name='Teléfono')),
                ...
                ('usuario', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='alumno', to=settings.AUTH_USER_MODEL, verbose_name='Usuario')),
